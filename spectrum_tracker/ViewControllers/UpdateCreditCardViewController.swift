...
class UpdateCreditCardViewController: UIViewController {
    ...
    @IBAction func onUpdateCreditCard(_ sender: Any) {
        ...
        if(expDate == "") {
            self.view.makeToast("please enter exp date")
            return
        }
        if(cvCode == "") {
        ...
        request.responseString { dataResponse in
            ...
            if(code == 200) {
                ...
                if(transaction_status == "approved") {
                    ...
                    self.view.makeToast("Retry your credit card. If still not working, please contact us for assistance")
                }
    ...
    func updateCreditCardInfoSecondary(_ userId: String, _ creditTokenInfo: CreditTokenInfoModel) {
        ...
        request.responseString { dataResponse in
            ...
            if(code == 200) {
                self.view.makeToast("You have successfully updated credit card info")
            } else {
