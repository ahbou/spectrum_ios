        ...
        for asset in assetList{
            if asset.isSelected == true {
                ...
                let parameters: Parameters = [
                    ...
                    "trackerId": asset.trackerId as String,
...
//        }
    ...
    func loadTrackersFrom(_ assetIdOnSelectedAssetList: Int) {
        ...
        if(firstLoadFlag)
        {
            asset = assetList[assetIdOnSelectedAssetList]
        }
        else{
            ...
            asset = selectedAssets[assetIdOnSelectedAssetList]
        }
        if(assetIdOnSelectedAssetList == assetList.count-1){
            firstLoadFlag = false
            print("Load finished!!!")
        }
        if URLManager.isConnectedToInternet == false {
